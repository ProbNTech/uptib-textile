...
/** Buyer FAQs live on the Buying House page. */
export const buyerFaqs: Faq[] = [
  ...
  },
  {
    ...
    a: "From 50 to 100 pcs with specialist makers to several hundred per size/colour for bulk bedding and towelling.",
  },
  {
    q: "How is quality guaranteed?",
    a: "Independent on-the-ground inspection against your approved sample, covering in-line, midline and final pre-shipment to AQL.",
  },
  {
...
export const homeFaqs: Faq[] = [
  {
    q: "Who is Pak Textiles Global Partners for?",
  ...
  {
    q: "I'm a UK buyer: how do I source from Pakistan?",
    a: "Send a brief or request a quote. We match it to vetted factories, arrange samples, control quality on the ground and deliver to the UK, with one accountable, UK-based partner end to end.",
  },
  {
    q: "I'm a Pakistani manufacturer: how do I reach UK buyers?",
    a: "Join as a member. You get a profile in front of UK buyers, market intelligence, matchmaking, a directory listing and a place in the pool we actively source from for live orders.",
  },
  {
    q: "How is quality guaranteed?",
    a: "Independent, on-the-ground inspection against your approved sample, covering raw material, in-line, midline at 40 to 50% and final pre-shipment to your AQL. Nothing ships until it passes.",
  },
  {
    q: "Do you handle shipping and customs?",
    a: "Yes. We coordinate freight (typically FOB Karachi or Port Qasim), customs clearance, export documentation and IOR/EOR, with the GSP+ duty-free advantage built into your landed price.",
  },
  {
    q: "What's the minimum order?",
    a: "From 50 to 100 pieces with specialist makers to several hundred per size/colour for bulk bedding and towelling, and we match your volume to the right factory.",
  },
];

/** Home-page FAQs — exporter-facing, global. Grounded in the Pak Textiles Global Partners strategy & content docs. */
export const homeExporterFaqs: Faq[] = [
  {
    q: "What does Pak Textiles Global Partners do for Pakistani exporters?",
    a: "We make Pakistani textile manufacturers visible, credible and reachable to buyers worldwide, and we run the services that get their products to market: professional profiles and branding, market intelligence, B2B matchmaking, digital campaigns, e-commerce and warehousing, and global market access.",
  },
  {
...
export const aboutFaqs: Faq[] = [
  {
    q: "What is Pak Textiles Global Partners?",
  ...
  {
    q: "How is Pak Textiles Global Partners related to UPTIB?",
    a: "UPTIB is our parent company, the UK-Pakistan Trade and Investment Board. Pak Textiles Global Partners is its dedicated textile division, focused solely on connecting Pakistan's textile makers with buyers worldwide.",
  },
  {
  ...
  },
  {
    ...
    a: "Independent, on-the-ground inspection against your approved sample, covering raw material, in-line, midline and final pre-shipment to your AQL. Nothing ships until it passes.",
  },
  {
