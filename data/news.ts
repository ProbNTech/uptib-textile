/* Pak Textiles Global Partners — News / insights content.
...
export const articles: Article[] = [
  {
    ...
    body: [
      ...
      },
      {
        ...
        paragraphs: [
          "Whether you're testing Pakistan on a single trial order or building an ongoing procurement programme, the route is the same: send a brief, review samples and pricing, and let an accountable partner manage quality and delivery to your market. Pak Textiles Global Partners sources from a vetted network of Pakistani manufacturers and delivers landed, on-spec and on-time, anywhere in the world.",
        ],
      },
    ],
  },
  {
    ...
    body: [
      ...
      },
      {
        heading: "Getting started",
        paragraphs: [
          "The simplest way to capture the benefit is to source through an accountable partner who confirms eligibility and handles the origin paperwork end-to-end. Pak Textiles Global Partners sources garments from a vetted network of Pakistani manufacturers and delivers landed, on-spec and duty-optimised into the UK.",
        ],
      },
    ],
  },
    ...
    body: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Wherever Pakistan fits in your strategy, the route in is the same: send a clear brief, approve samples in writing, and let an accountable partner manage quality and delivery. Pak Textiles Global Partners sources from a vetted network of Pakistani manufacturers and delivers landed, on-spec and on-time, anywhere in the world.",
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    body: [
      ...
      },
      {
        heading: "Getting started",
        paragraphs: [
          "Whether you're a hotel group placing a recurring bath-linen order or an online brand testing a first private-label range, the route is the same: send a brief with your specs and target price, review samples, and let an accountable partner manage quality and delivery to your market. Pak Textiles Global Partners sources home textiles from a vetted network of Pakistani manufacturers and delivers landed, on-spec and on-time, anywhere in the world.",
        ],
      },
    ],
  },
