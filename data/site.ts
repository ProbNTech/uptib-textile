export const site = {
  ...
  disclaimer:
    "Pak Textiles Global Partners is the textile division of the UK Pakistan Trade & Investment Board (ukpaktrade.org.uk). Market and trade figures are indicative and refreshed periodically.",
} as const;
