...
export const WHATSAPP_MESSAGE =
  "Hello Pak Textiles Global Partners,\n\nI came across your website and would like to learn more about Pak Textiles Global Partners membership and how to get involved.\n\nCould you share more details?";
