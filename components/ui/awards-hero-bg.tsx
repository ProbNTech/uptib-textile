  ...
  return (
    <div className="absolute inset-0 z-[1] overflow-hidden pointer-events-none">
      ...
      <motion.div
        ...
        style={{
          background: "radial-gradient(circle, rgba(140, 154, 171,0.06) 0%, transparent 60%)",
          filter: "blur(50px)",
        }}
        {...(shouldReduceMotion ? {} : {
      ...
      >
        ...
        {[
          ...
          { x: 400, y: 500, size: 10, delay: 1, color: "#394F73" },
          { x: 1100, y: 480, size: 12, delay: 1.5, color: "#B3AA98" },
          { x: 680, y: 60, size: 8, delay: 0.8, color: "#394F73" },
          { x: 300, y: 300, size: 10, delay: 2, color: "#394F73" },
          { x: 1250, y: 340, size: 8, delay: 1.2, color: "#394F73" },
          { x: 550, y: 520, size: 10, delay: 0.3, color: "#B3AA98" },
          { x: 150, y: 450, size: 6, delay: 1.8, color: "#394F73" },
          { x: 1350, y: 200, size: 8, delay: 0.6, color: "#B3AA98" },
          { x: 750, y: 540, size: 7, delay: 2.2, color: "#394F73" },
          { x: 480, y: 120, size: 6, delay: 1.6, color: "#394F73" },
        ].map((star, i) => {
          const s = star.size;
        ...
        <motion.g {...float(1, 5)}>
          ...
          {/* Ribbon */}
          <path d="M180 148 L175 120 M220 148 L225 120" stroke="#78899B" strokeWidth="1.5" opacity="0.08" />
        </motion.g>
        ...
        <motion.g {...float(2, 5.5)}>
          ...
          <path d="M1262 394 L1258 370 M1298 394 L1302 370" stroke="#78899B" strokeWidth="1.5" opacity="0.08" />
        </motion.g>
