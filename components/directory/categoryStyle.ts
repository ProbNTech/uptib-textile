...
export const CATEGORY_STYLE: Record<CompanyCategory, CategoryStyle> = {
  "AI & Automation": {
    color: "#2F7549",
    accent: "#6FA9FF",
    gradient: "linear-gradient(135deg, #2F7549 0%, #6FA9FF 100%)",
    icon: Brain,
  ...
  Cybersecurity: {
    color: "#2F7549",
    accent: "#FCA5A5",
    gradient: "linear-gradient(135deg, #2F7549 0%, #FCA5A5 100%)",
    icon: ShieldAlert,
  ...
  Data: {
    color: "#3E8F5E",
    accent: "#86EFAC",
    gradient: "linear-gradient(135deg, #3E8F5E 0%, #86EFAC 100%)",
    icon: Database,
  ...
  "Home & Hospitality Textiles": {
    color: "#2F7549",
    accent: "#8FD3AE",
    gradient: "linear-gradient(135deg, #2F7549 0%, #8FD3AE 100%)",
    icon: BedDouble,
  ...
  "Sportswear & Activewear": {
    color: "#0D9488",
    accent: "#8FD8C9",
    gradient: "linear-gradient(135deg, #0D9488 0%, #8FD8C9 100%)",
    icon: Dumbbell,
  ...
  "Sourcing & Buying House": {
    color: "#3C8F5E",
    accent: "#8FD3AE",
    gradient: "linear-gradient(135deg, #3C8F5E 0%, #8FD3AE 100%)",
    icon: Handshake,
