      ...
      <div className="flex items-center justify-end gap-4 mt-8">
        ...
        <div className="flex gap-3 shrink-0">
          <button
            ...
            className="group w-11 h-11 flex items-center justify-center rounded-full bg-[#78899B] shadow-md hover:bg-[#A3AEBC] hover:scale-105 transition-[transform,background-color] duration-300 ease-out"
          >
            <svg
