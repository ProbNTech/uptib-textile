      ...
      <div className="flex items-center justify-end gap-4 mt-8">
        ...
        <div className="flex gap-3 shrink-0">
          <button
            ...
            className="group w-11 h-11 flex items-center justify-center rounded-full bg-[#1E2733] shadow-md hover:bg-[#5C6B7E] hover:scale-105 transition-[transform,background-color] duration-300 ease-out"
          >
            <svg
