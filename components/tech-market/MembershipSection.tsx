...
const PolicyIcon = ({ className, style }: { className?: string; style?: React.CSSProperties }) => (
  <svg className={className} style={style} viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M60 100L20 78V72L60 94L100 72V78L60 100z" fill="#065F46" opacity="0.3"/>
    ...
    <rect x="32" y="38" width="12" height="8" rx="1" fill="#6EE7B7" opacity="0.3"/>
    <rect x="32" y="49" width="12" height="8" rx="1" fill="#6EE7B7" opacity="0.3"/>
    <rect x="32" y="60" width="12" height="8" rx="1" fill="#6EE7B7" opacity="0.25"/>
    {/* Building/pillar right */}
    <rect x="74" y="42" width="16" height="38" rx="2" fill="url(#pol2)" opacity="0.8"/>
    <rect x="76" y="45" width="12" height="8" rx="1" fill="#6EE7B7" opacity="0.3"/>
    <rect x="76" y="56" width="12" height="8" rx="1" fill="#6EE7B7" opacity="0.3"/>
    <rect x="76" y="67" width="12" height="8" rx="1" fill="#6EE7B7" opacity="0.25"/>
    {/* Central shield */}
    <path d="M60 12L42 22v18c0 12 8 22 18 26 10-4 18-14 18-26V22L60 12z"
      fill="url(#pol1)" stroke="#34D399" strokeWidth="1.5" strokeLinejoin="round"/>
    <path d="M60 18L46 26v14c0 10 6.5 18 14 22 7.5-4 14-12 14-22V26L60 18z"
      fill="#047857" fillOpacity="0.6" stroke="#6EE7B7" strokeWidth="0.8"/>
    {/* Checkmark inside shield */}
    <path d="M52 36l6 6 12-12" stroke="#ECFDF5" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" filter="url(#polGlow)"/>
    {/* Document pages floating */}
    <rect x="48" y="62" width="24" height="18" rx="2" fill="#10B981" stroke="#6EE7B7" strokeWidth="0.8"/>
    <line x1="52" y1="67" x2="68" y2="67" stroke="#6EE7B7" strokeWidth="1.5" strokeLinecap="round"/>
    <line x1="52" y1="71" x2="64" y2="71" stroke="#6EE7B7" strokeWidth="1.5" strokeLinecap="round" opacity="0.7"/>
    <line x1="52" y1="75" x2="60" y2="75" stroke="#6EE7B7" strokeWidth="1.5" strokeLinecap="round" opacity="0.5"/>
    {/* Glowing dots */}
    <circle cx="26" cy="30" r="2" fill="#34D399" opacity="0.6"/>
    <circle cx="95" cy="38" r="1.5" fill="#6EE7B7" opacity="0.5"/>
    <circle cx="15" cy="55" r="1.5" fill="#10B981" opacity="0.4"/>
    <circle cx="105" cy="60" r="2" fill="#34D399" opacity="0.4"/>
  </svg>
);
...
const InnovationIcon = ({ className, style }: { className?: string; style?: React.CSSProperties }) => (
  <svg className={className} style={style} viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M60 14c-18 0-28 14-28 28 0 10 6 18 12 24 2 2 4 6 4 10h24c0-4 2-8 4-10 6-6 12-14 12-24 0-14-10-28-28-28z"
      fill="url(#inn1)" stroke="#6EE7B7" strokeWidth="1.5"/>
    {/* Bulb glass reflection */}
    <path d="M48 36c0-8 5-16 14-18" stroke="#ECFDF5" strokeWidth="2" strokeLinecap="round" opacity="0.6"/>
    {/* Filament glow */}
    <path d="M52 42c4-6 12-6 16 0" stroke="#6EE7B7" strokeWidth="2.5" strokeLinecap="round" filter="url(#innBlur)"/>
    <path d="M55 42c2.5-3.5 7.5-3.5 10 0" stroke="#D1FAE5" strokeWidth="1.5" strokeLinecap="round"/>
    {/* Light rays */}
    <line x1="60" y1="6" x2="60" y2="12" stroke="#6EE7B7" strokeWidth="2" strokeLinecap="round" opacity="0.8"/>
    <line x1="30" y1="20" x2="35" y2="25" stroke="#6EE7B7" strokeWidth="2" strokeLinecap="round" opacity="0.6"/>
    <line x1="90" y1="20" x2="85" y2="25" stroke="#34D399" strokeWidth="2" strokeLinecap="round" opacity="0.6"/>
    <line x1="22" y1="42" x2="28" y2="42" stroke="#6EE7B7" strokeWidth="2" strokeLinecap="round" opacity="0.5"/>
    <line x1="98" y1="42" x2="92" y2="42" stroke="#34D399" strokeWidth="2" strokeLinecap="round" opacity="0.5"/>
    {/* Bulb base */}
    <rect x="48" y="76" width="24" height="4" rx="1" fill="#34D399" opacity="0.8"/>
    <rect x="50" y="80" width="20" height="3" rx="1" fill="#10B981" opacity="0.7"/>
    <rect x="52" y="83" width="16" height="3" rx="1" fill="#059669" opacity="0.6"/>
    {/* Gear left */}
    <circle cx="22" cy="70" r="10" fill="url(#inn2)" fillOpacity="0.7" stroke="#6EE7B7" strokeWidth="1"/>
    <circle cx="22" cy="70" r="5" fill="#065F46" stroke="#6EE7B7" strokeWidth="0.8"/>
    <rect x="19" y="58" width="6" height="4" rx="1" fill="#10B981"/>
    <rect x="19" y="78" width="6" height="4" rx="1" fill="#10B981"/>
    <rect x="10" y="67" width="4" height="6" rx="1" fill="#10B981"/>
    <rect x="30" y="67" width="4" height="6" rx="1" fill="#10B981"/>
    {/* Gear right */}
    <circle cx="98" cy="72" r="8" fill="url(#inn2)" fillOpacity="0.6" stroke="#34D399" strokeWidth="1"/>
    <circle cx="98" cy="72" r="4" fill="#047857" stroke="#34D399" strokeWidth="0.8"/>
    <rect x="95.5" y="62.5" width="5" height="3.5" rx="1" fill="#047857"/>
    <rect x="95.5" y="78" width="5" height="3.5" rx="1" fill="#047857"/>
    <rect x="88.5" y="69.5" width="3.5" height="5" rx="1" fill="#047857"/>
    <rect x="104" y="69.5" width="3.5" height="5" rx="1" fill="#047857"/>
    {/* Circuit/connection lines */}
    <path d="M34 70h12" stroke="#6EE7B7" strokeWidth="1" strokeDasharray="3 2" opacity="0.5"/>
    <path d="M74 72h14" stroke="#34D399" strokeWidth="1" strokeDasharray="3 2" opacity="0.5"/>
    {/* Sparkle dots */}
    <circle cx="40" cy="16" r="1.5" fill="#6EE7B7" opacity="0.8"/>
    <circle cx="80" cy="14" r="1.5" fill="#34D399" opacity="0.8"/>
    <circle cx="16" cy="50" r="1" fill="#6EE7B7" opacity="0.6"/>
    <circle cx="104" cy="48" r="1" fill="#34D399" opacity="0.6"/>
    {/* Stars */}
    <path d="M100 18l1.5 3 3 .5-2 2.2.5 3.3-3-1.5-3 1.5.5-3.3-2-2.2 3-.5z" fill="#6EE7B7" opacity="0.7"/>
  </svg>
);
...
const MarketsIcon = ({ className, style }: { className?: string; style?: React.CSSProperties }) => (
  <svg className={className} style={style} viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    {/* Globe */}
    <circle cx="60" cy="50" r="32" fill="#064E3B" fillOpacity="0.4" stroke="url(#mkt1)" strokeWidth="2"/>
    <ellipse cx="60" cy="50" rx="32" ry="12" stroke="#059669" strokeWidth="0.8" opacity="0.35"/>
    <ellipse cx="60" cy="50" rx="12" ry="32" stroke="#059669" strokeWidth="0.8" opacity="0.35"/>
    <ellipse cx="60" cy="50" rx="24" ry="32" stroke="#059669" strokeWidth="0.5" opacity="0.2"/>
    {/* Continent shapes (abstract) */}
    <path d="M42 38c4-2 8 0 12-1s6-4 10-2c2 1 4 4 2 6s-6 2-8 4-2 6-6 6-6-2-8-4-4-6-2-9z" fill="#6EE7B7" opacity="0.2"/>
    <path d="M62 55c3 0 6 2 10 1s6-3 8-1c1 2-1 5-3 6s-6 0-8 2-2 4-5 4-4-2-5-4 0-5 3-8z" fill="#059669" opacity="0.15"/>
    {/* Rising chart bars */}
    ...
    <rect x="82" y="50" width="10" height="50" rx="2" fill="#047857"/>
    {/* Bar highlights */}
    <rect x="28" y="80" width="6" height="3" rx="1" fill="#D1FAE5" opacity="0.4"/>
    <rect x="42" y="74" width="6" height="3" rx="1" fill="#D1FAE5" opacity="0.4"/>
    <rect x="56" y="67" width="6" height="3" rx="1" fill="#D1FAE5" opacity="0.4"/>
    <rect x="70" y="60" width="6" height="3" rx="1" fill="#D1FAE5" opacity="0.4"/>
    <rect x="84" y="52" width="6" height="3" rx="1" fill="#D1FAE5" opacity="0.4"/>
    {/* Trend arrow */}
    ...
    <text x="18" y="42" fill="#6EE7B7" fontSize="10" fontWeight="bold" opacity="0.6">$</text>
    <text x="96" y="35" fill="#059669" fontSize="8" fontWeight="bold" opacity="0.5">€</text>
    <text x="105" y="70" fill="#6EE7B7" fontSize="9" fontWeight="bold" opacity="0.5">£</text>
    {/* Sparkle dots */}
    <circle cx="20" cy="25" r="1.5" fill="#6EE7B7" opacity="0.7"/>
    <circle cx="100" cy="22" r="1.5" fill="#34D399" opacity="0.6"/>
    <circle cx="12" cy="65" r="1" fill="#6EE7B7" opacity="0.5"/>
  </svg>
);
          ...
          <div className="flex flex-col lg:flex-row gap-10 lg:gap-14">
            ...
            <div className="lg:w-1/3 flex flex-col justify-center">
              <div className="flex items-center gap-3 mb-4">
                ...
                <p className="text-sm font-bold uppercase tracking-[0.22em] text-[#047857]">Our Focus</p>
              </div>
            ...
            <div className="lg:w-2/3 grid grid-cols-1 sm:grid-cols-3 gap-6">
              {[
                ...
                return (
                  <div
                    key={card.title}
                    className="group rounded-2xl bg-white border border-[#E5E7EB] shadow-sm p-6 hover:-translate-y-1 hover:shadow-xl hover:border-[#047857]/20 transition-all duration-300 text-center"
                  >
