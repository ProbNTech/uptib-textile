      ...
      <div className="px-8 sm:px-12 lg:px-16 xl:px-20">
          ...
          {activeFilterCount > 0 && (
            <div className="flex items-center gap-2 mt-4 pt-4 border-t border-[#EEECEA]">
              ...
              <button
                ...
                className="text-base text-[#6B7280] hover:text-[#1A1A1A] underline ml-2 transition-colors"
              >
                Clear all
              </button>
            </div>
        ...
        <div className="flex items-center justify-between mb-6">
          <p className="text-base text-[#4B5563]">
            Showing <span className="font-semibold text-[#1A1A1A]">{filtered.length}</span>{" "}
        ...
        {filtered.length > 0 ? (
          ...
          <div className="bg-white border border-[#D8D5CF] rounded-lg p-12 text-center mb-10">
            ...
            <h3 className="font-heading font-bold text-[#1A1A1A] text-lg mb-2">
              No members found
            </h3>
        ...
        <div className="bg-white border border-[#D8D5CF] rounded-lg p-10 text-center">
          <h2 className="font-heading font-bold text-[#1A1A1A] text-xl mb-3">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <Link
              href="/contact"
              className="inline-flex items-center gap-2 px-7 py-3 rounded-full border border-[#1A1A1A] text-[#1A1A1A] text-base font-semibold hover:bg-[#1A1A1A] hover:text-white transition-colors duration-300"
            >
              Contact Us
            </Link>
          </div>
