...
export function Button({
  ...
  const baseStyles = "relative overflow-hidden inline-flex items-center justify-center gap-2 font-semibold transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-[#78899B] focus:ring-offset-2 rounded-full group";
  ...
  const variants = {
    primary: "bg-[#1A1A1A] text-white hover:bg-[#78899B]",
    secondary: "border border-[#1A1A1A] text-[#1A1A1A] hover:bg-[#1A1A1A] hover:text-white hover:shadow-glow-primary",
    ghost: "text-[#1A1A1A] underline underline-offset-4 hover:text-[#394F73]",
