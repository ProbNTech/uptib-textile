  ...
  return (
    <motion.div variants={itemVariants} className="flex items-center gap-2.5 mb-5">
      ...
      <div>
        ...
        <h3 className="text-sm font-bold text-[#1A1A1A] leading-tight">{title}</h3>
      </div>
    </motion.div>
  );
}
    ...
    return (
      ...
      >
        ...
        <div className="px-10 py-16 text-center">
          ...
          <h3 className="font-heading font-extrabold text-2xl text-[#1A1A1A] mb-3">Something went wrong</h3>
