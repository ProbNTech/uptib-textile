              ...
              <div className="lg:sticky lg:top-28 lg:self-start lg:max-w-sm">
                ...
                <div className="flex flex-wrap gap-2">
                  {p.certList.map((c) => (
                    <span
                      key={c}
                      className="inline-flex items-center gap-1.5 rounded-full bg-white/10 px-3 py-1.5 text-xs font-bold text-[#B3AA98]"
                    >
                ...
                <dl className="divide-y divide-white/10">
                  {factRows.map((row) => (
                    <div key={row.label} className="grid grid-cols-1 sm:grid-cols-3 gap-2 px-6 py-6">
                      <dt className="font-heading font-bold text-[#B3AA98] text-sm uppercase tracking-wide">{row.label}</dt>
