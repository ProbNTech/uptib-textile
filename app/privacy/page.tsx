            ...
            <div className="space-y-5">
              ...
              >
                ...
                <p className="text-base text-[#7A7E8F] leading-relaxed">
                  For example, we may obtain information about you when you decide to become a member, partner or key stakeholder of Pakistan Textile Partners or take part in one of our events, or when you register to receive one of our newsletters. Pakistan Textile Partners collects information directly from individuals or from the parent companies of the individuals. The information could be collected through emails, phone calls, online registration forms, event registration forms and face-to-face meetings. Pakistan Textile Partners collects personal data about individuals when there is a legitimate basis, a contract or when such information is provided on a voluntary basis.
                </p>
              </motion.div>
          ...
          <AnimatedSection>
            ...
            <div className="space-y-5 max-w-5xl">
              ...
              <motion.div initial={shouldReduceMotion ? { opacity: 1 } : { opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-50px" }} transition={{ duration: 0.4, delay: 0.12 }} className="relative bg-white border border-[#D8D5CF] rounded-xl p-6 hover:shadow-md transition-all duration-300 overflow-hidden shadow-sm">
                ...
                <p className="text-base text-[#7A7E8F] leading-relaxed mb-4">Where it is reasonably necessary to achieve our legitimate interests, i.e. those required for running Pakistan Textile Partners as a B2B strategic networking organization in pursuit of our shared aims and ideals. For example, to:</p>
