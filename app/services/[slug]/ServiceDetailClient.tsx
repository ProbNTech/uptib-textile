            ...
            <div className="space-y-12">
              {d.blocks.map((block, bi) => {
                          ...
                          return (
                            <div key={item} className="flex flex-col gap-2.5">
                              {logo ? (
                                ...
                                <span className="inline-flex size-10 items-center justify-center rounded-xl border border-white/20 bg-white/10 text-[#B3AA98]">
                ...
                if (block.type === "steps") {
                  ...
                  return (
                    <div key={bi}>
                      <h3 className="font-heading font-extrabold text-[#1A1A1A] text-2xl mb-2">{block.title}</h3>
                        ...
                        <div className={cn("grid grid-cols-1 sm:grid-cols-2 gap-5 lg:gap-6", lgCols)}>
                          {block.items.map((it, i) => {
                            ...
                            return (
                              ...
                              >
                                <span className="inline-flex size-12 items-center justify-center rounded-xl border border-white/20 bg-white/10 text-[#B3AA98] mb-5">
                                ...
                                <p className="mt-2 font-heading font-bold text-[15px] text-[#B3AA98]">{it.label}</p>
                        ...
                        >
                          ...
                          <ul className="space-y-4">
                            {block.with.points.map((p) => (
                              <li key={p} className="flex items-start gap-3">
                                <span className="mt-0.5 inline-flex size-6 shrink-0 items-center justify-center rounded-full bg-[#B3AA98]/20 text-[#B3AA98]">
                              ...
                              <div className="relative mb-5 flex flex-wrap items-center gap-3">
                                <span
                                  className={cn(
                                    ...
                                    brand ? "bg-[#B3AA98]/20 text-[#B3AA98]" : "bg-[#D1D5DB] text-[#6B7280]",
                                  )}
                                  aria-hidden
                                >
                                ...
                                {lane.note && (
                                  <span
                                    className={cn(
                                      ...
                                      brand ? "bg-white/10 text-[#B3AA98]" : "bg-[#E5E7EB] text-[#9CA3AF]",
                                    )}
                                  >
                                    {lane.note}
                                  </span>
