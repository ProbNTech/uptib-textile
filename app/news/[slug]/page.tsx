    ...
    <>
      ...
      <Section variant="light" pattern>
        ...
        <article className="max-w-3xl mx-auto content-body">
          ...
          <p className="text-[#1A1A1A] text-xl leading-relaxed mb-10 font-medium">{a.excerpt}</p>
          {a.body.map((section) => (
            <section key={section.heading} className="mb-10">
              <h2 className="font-heading font-extrabold text-[#1A1A1A] text-2xl mb-4">{section.heading}</h2>
