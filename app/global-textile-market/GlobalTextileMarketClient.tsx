      ...
      <div className="relative grid lg:grid-cols-2 items-center gap-10 px-7 sm:px-10 lg:px-14 py-8 lg:py-10">
        ...
        <div aria-hidden className="relative hidden lg:block h-[280px]">
          ...
          <div
            ...
            style={{
              backgroundImage:
                "radial-gradient(circle, rgba(216, 205, 186,0.4) 1.1px, transparent 1.4px)",
          ...
          >
            <span className="absolute inset-0 -m-2 rounded-full bg-[#B3AA98]/15 ring-2 ring-[#B3AA98]/30" />
            <span className="relative flex h-[5.5rem] w-[5.5rem] items-center justify-center overflow-hidden rounded-full bg-white shadow-2xl ring-4 ring-[#B3AA98]/60">
          ...
          <div className="grid lg:grid-cols-12 gap-6 items-stretch mb-7">
            ...
            <div className="lg:col-span-4 relative min-h-[230px] rounded-2xl overflow-hidden">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-5 sm:p-6">
                ...
                <p className="text-[#B3AA98] font-semibold text-sm mt-1.5 leading-snug">{region.tagline}</p>
              </div>
            </div>
        ...
        <div className="relative px-8 sm:px-12 lg:px-16 xl:px-20 py-8 lg:py-10">
          <div className="grid lg:grid-cols-12 gap-10 lg:gap-14 items-start">
            ...
            <AnimatedSection animation="slide-right" className="lg:col-span-4">
              <div className="inline-flex items-center gap-2 mb-5">
                  <span className="text-sm font-bold uppercase tracking-[0.18em] text-[#B3AA98]">
                  Competitive Landscape
                </span>
              </div>
              ...
              <div className="mt-7">
                <span className="flex items-center gap-2 text-xs font-semibold uppercase tracking-[0.14em] text-white/60">
                  <Globe2 className="w-4 h-4 text-[#B3AA98]" /> Competing against
                </span>
                  ...
                  <AnimatedSection key={a.title} delay={(i % 3) * 0.08}>
                    <div>
                      <div className="flex items-center gap-2.5 mb-2.5">
                        <Icon className="w-5 h-5 shrink-0 text-[#B3AA98]" strokeWidth={1.7} aria-hidden />
