...
const orgChart = [
  {
    ...
    responsibilities: [
      "Provide strategic oversight and governance for Pak Textiles Global Partners",
      ...
      "Serve as a senior ambassador for Pak Textiles Global Partners in formal settings",
    ],
  },
  {
    title: "President",
    ...
    level: "Executive Leadership",
    responsibilities: [
      "Provide strategic direction and vision for Pak Textiles Global Partners",
      "Lead day-to-day operations and strategic execution",
      "Represent Pak Textiles Global Partners at the highest levels with governments and international bodies",
  ...
  },
  {
    ...
    responsibilities: [
      "Lead Pak Textiles Global Partners activities and membership engagement in assigned regions",
      ...
      "Represent Pak Textiles Global Partners at regional forums and conferences",
    ],
  },
  {
...
const governanceCards = [
  ...
  { id: "executive-leadership", title: "Executive Leadership", desc: "Day-to-day operations and strategic execution of Pak Textiles Global Partners initiatives.", tags: ["Execution", "Operations"], colorIdx: 0 },
];
  ...
  return (
    <div>
      ...
      <Section variant="light">
        <AnimatedSection>
          <SectionHeader label="Our Framework" title="Organisational Structure" subtitle="Pak Textiles Global Partners operates through a clearly defined hierarchy with defined roles, responsibilities, and reporting lines." color="blue" />
              ...
              >
                ...
                <div className="relative">
                  <div className="flex items-center justify-between mb-3">
                    <h3 className="font-heading font-bold text-lg text-[#1A1A1A]">{card.title}</h3>
      ...
      <Section variant="light">
        <AnimatedSection>
          <SectionHeader label="Leadership Roles" title="Key Positions &amp; Responsibilities" subtitle="Each role within Pak Textiles Global Partners has defined responsibilities and accountability lines." color="red" />
                ...
                >
                  ...
                  <div className="relative bg-white rounded-2xl p-6 h-full">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <div>
                        <h3 className="font-heading font-bold text-base text-[#1A1A1A]">{role.title}</h3>
      ...
      <GovernanceSection
        ...
        desc="A comprehensive framework ensuring accountability, transparency, and ethical decision-making across all Pak Textiles Global Partners operations."
        image="/image/Leadership%20Governance/Governance_Structure.webp" imageAlt="Pak Textiles Global Partners Governance Structure" imageLeft={false}
      ...
      <GovernanceSection
        ...
        desc="Strategic oversight and governance at the highest level, ensuring Pak Textiles Global Partners' mission and values guide all decisions."
        image="https://images.unsplash.com/photo-1600880292203-757bb62b4baf?w=1200&q=90&auto=format&fit=crop" imageAlt="Pak Textiles Global Partners Board of Directors in a professional boardroom meeting" imageLeft={true}
      ...
      <GlobalCTA
        ...
        subtitle="Our structure ensures every member has a voice. Learn more about how you can contribute to Pak Textiles Global Partners' mission."
