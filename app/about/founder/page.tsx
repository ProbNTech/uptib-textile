  ...
  return (
    <div>
          ...
          <div className="grid lg:grid-cols-[300px_1fr] gap-10 items-center">
            ...
            >
              <div className="relative aspect-[3/4] overflow-hidden rounded-lg shadow-xl">
                <Image src="/image/ceo/khalil-choudhary-headshot.jpg" alt="Khalil Choudhary, President, Pak Textiles Global Partners" fill className="object-cover" sizes="300px" />
              </div>
            ...
            >
              ...
              <h2 className="font-heading font-extrabold text-3xl lg:text-4xl text-[#1A1A1A] mb-3">Khalil Choudhary</h2>
              ...
              <p className="text-[#3D4152] leading-relaxed mb-4">
                A visionary leader dedicated to strengthening the UK-Pakistan technology corridor through innovation, collaboration, and sustainable partnerships. Under his leadership, Pak Textiles Global Partners has grown into a strategic platform connecting technology professionals, entrepreneurs, and organisations across both nations.
              </p>
              <p className="text-[#3D4152] leading-relaxed">
                With deep expertise in technology strategy, bilateral trade, and community building, Khalil Choudhary drives Pak Textiles Global Partners&apos; mission to champion Pakistan&apos;s soft image globally while creating pathways for prosperity through digital innovation.
              </p>
            </motion.div>
          </div>
        </AnimatedSection>
          ...
          <div className="grid lg:grid-cols-[1fr_2fr] gap-8 items-start">
            <div className="bg-white border border-[#D8D5CF] rounded-lg p-8 border-t-4 border-t-[#78899B]">
              <div className="w-24 h-24 rounded-full overflow-hidden mb-5 ring-2 ring-[#78899B]/20 ring-offset-2">
                <Image
                  ...
                  alt="Khalil Choudhary, President, Pak Textiles Global Partners"
                  width={96}
                  height={96}
              ...
              <p className="text-base text-[#394F73] font-semibold mb-3">President, Pak Textiles Global Partners</p>
            ...
            <div>
              ...
              <p className="text-[#3D4152] text-base leading-relaxed">
                I invite you to join us on this journey. Whether you are a seasoned technology professional, an emerging entrepreneur, an investor seeking opportunities, or a policy maker shaping the future, there is a place for you at Pak Textiles Global Partners. Together, we can build something extraordinary.
              </p>
            </div>
          </div>
        </AnimatedSection>
      ...
      <GlobalCTA
        ...
        title="Be Part of the Pak Textiles Global Partners Story"
