...
const broaderImpact = [
  { icon: Globe2, title: "Global Market Access", desc: "Expand global market access and exports for UK and Pakistani tech companies.", color: "#394F73" },
  { icon: Handshake, title: "Strategic Partnerships", desc: "Build strategic partnerships across industry, government, and academia.", color: "#394F73" },
  { icon: TrendingUp, title: "Investment & Innovation", desc: "Unlock investment and innovation opportunities for growing businesses.", color: "#394F73" },
  { icon: Zap, title: "Technology Transfer", desc: "Promote technology transfer between the United Kingdom and Pakistan.", color: "#394F73" },
];
  ...
  return (
    <div>
      ...
      <Section variant="dark">
        <AnimatedSection>
          <SectionHeader label="Strategic Objectives" title="Key Focus Areas" color="green" subtitle="Detailed objectives driving Pak Textiles Global Partners' mission to empower Pakistani IT professionals and foster innovation worldwide." />
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-white/5 border border-white/10 rounded-lg p-6 hover:bg-white/10 transition-all duration-300">
              <div className="w-10 h-10 rounded-lg flex items-center justify-center mb-4" style={{ background: "#78899B15", border: "1px solid #78899B30" }}>
                <TrendingUp className="w-5 h-5 text-[#394F73]" strokeWidth={1.5} />
              </div>
            ...
            <div className="bg-white/5 border border-white/10 rounded-lg p-6 hover:bg-white/10 transition-all duration-300">
              <div className="w-10 h-10 rounded-lg flex items-center justify-center mb-4" style={{ background: "#78899B15", border: "1px solid #78899B30" }}>
                <Monitor className="w-5 h-5 text-[#394F73]" strokeWidth={1.5} />
              </div>
              <h3 className="font-heading font-bold text-white text-base mb-2">Local Community Support</h3>
              <p className="text-white/70 text-base leading-relaxed">Develop Tech Centers with co-working spaces. Facilitate IT support services to local communities through Pak Textiles Global Partners.</p>
            </div>
            <div className="bg-white/5 border border-white/10 rounded-lg p-6 hover:bg-white/10 transition-all duration-300">
              <div className="w-10 h-10 rounded-lg flex items-center justify-center mb-4" style={{ background: "#78899B15", border: "1px solid #78899B30" }}>
                <FlaskConical className="w-5 h-5 text-[#394F73]" strokeWidth={1.5} />
              </div>
            ...
            {broaderImpact.map((item) => {
              ...
              return (
                <div key={item.title} className="bg-white border border-[#D8D5CF] rounded-lg p-6 hover:shadow-md transition-all duration-300" style={{ borderTop: `3px solid ${item.color}` }}>
                  ...
                  <h3 className="font-heading font-bold text-[#1A1A1A] text-base mb-2">{item.title}</h3>
      ...
      <GlobalCTA
        ...
        subtitle="Become part of Pak Textiles Global Partners and contribute to the objectives that are shaping the future of UK-Pakistan technology collaboration."
