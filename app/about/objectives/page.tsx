...
const broaderImpact = [
  { icon: Globe2, title: "Global Market Access", desc: "Expand global market access and exports for UK and Pakistani tech companies.", color: "#1E2733" },
  { icon: Handshake, title: "Strategic Partnerships", desc: "Build strategic partnerships across industry, government, and academia.", color: "#1E2733" },
  { icon: TrendingUp, title: "Investment & Innovation", desc: "Unlock investment and innovation opportunities for growing businesses.", color: "#1E2733" },
  { icon: Zap, title: "Technology Transfer", desc: "Promote technology transfer between the United Kingdom and Pakistan.", color: "#1E2733" },
];
        ...
        <AnimatedSection>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="bg-white/5 border border-white/10 rounded-lg p-6 hover:bg-white/10 transition-all duration-300">
              <div className="w-10 h-10 rounded-lg flex items-center justify-center mb-4" style={{ background: "#1E273315", border: "1px solid #1E273330" }}>
                <TrendingUp className="w-5 h-5 text-[#1E2733]" strokeWidth={1.5} />
              </div>
            ...
            <div className="bg-white/5 border border-white/10 rounded-lg p-6 hover:bg-white/10 transition-all duration-300">
              <div className="w-10 h-10 rounded-lg flex items-center justify-center mb-4" style={{ background: "#1E273315", border: "1px solid #1E273330" }}>
                <Cpu className="w-5 h-5 text-[#1E2733]" strokeWidth={1.5} />
              </div>
            ...
            <div className="bg-white/5 border border-white/10 rounded-lg p-6 hover:bg-white/10 transition-all duration-300">
              <div className="w-10 h-10 rounded-lg flex items-center justify-center mb-4" style={{ background: "#1E273315", border: "1px solid #1E273330" }}>
                <Monitor className="w-5 h-5 text-[#1E2733]" strokeWidth={1.5} />
              </div>
