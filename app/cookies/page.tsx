...
const cookieTypes = [
  { icon: Shield, title: "Necessary", color: "#2F7549", desc: "These cookies are necessary in order to allow the Site to work correctly. They enable you to access the Site, move around, and access different services, features, and tools. Examples include remembering previous actions (e.g. entered text) when navigating back to a page in the same session. These cookies cannot be disabled." },
  { icon: Settings, title: "Functionality", color: "#3E8F5E", desc: "These cookies remember your settings and preferences and the choices you make (such as language or regional preferences) in order to help us personalize your experience and offer you enhanced functionality and content." },
  { icon: Lock, title: "Security", color: "#2F7549", desc: "These cookies can help us identify and prevent security risks. They may be used to store your session information to prevent others from changing your password without your login information." },
  { icon: BarChart3, title: "Performance", color: "#2F7549", desc: "These cookies can help us collect information to help us understand how you use our Site, for example whether you have viewed messages or specific pages and how long you spent on each page. This helps us improve the performance of our Site." },
  { icon: LineChart, title: "Analytics", color: "#3E8F5E", desc: "These cookies collect information regarding your activity on our Site to help us learn more about which features are popular with our users and how our Site can be improved." },
  { icon: Megaphone, title: "Advertising", color: "#2F7549", desc: "These cookies are placed in order to deliver content, including ads relevant and meaningful to you and your interests. They may also be used to deliver targeted advertising or to limit the number of times you see an advertisement. This can help us track how efficient advertising campaigns are, both for our own Services and for other websites. Such cookies may track your browsing habits and activity when visiting our Site and those of third parties" },
];
              ...
              <div className="relative bg-white border border-[#D8D5CF] rounded-2xl p-8 overflow-hidden shadow-sm">
                ...
                <div className="flex items-start gap-4 mb-5">
                  <div className="w-10 h-10 rounded-xl bg-[#2F7549]/10 border border-[#2F7549]/20 flex items-center justify-center flex-shrink-0">
                    <Cookie className="w-5 h-5 text-[#2F7549]" strokeWidth={1.5} />
                  </div>
                  <h3 className="font-heading font-bold text-lg text-[#16291E] pt-2">What Are Cookies</h3>
                </div>
                ...
                <div className="space-y-5">
                  ...
                  <p className="text-base text-[#5A5F72] leading-relaxed">Cookies are text files placed on your computer to collect standard internet log information and visitor behavior information. This information is used to track visitor use of the website and to compile statistical reports on website activity. For further information visit{" "}<a href="https://www.aboutcookies.org" target="_blank" rel="noopener noreferrer" className="text-[#2F7549] hover:text-[#8FD3AE] transition-colors">www.aboutcookies.org</a>{" "}or{" "}<a href="https://www.allaboutcookies.org" target="_blank" rel="noopener noreferrer" className="text-[#2F7549] hover:text-[#8FD3AE] transition-colors">www.allaboutcookies.org</a>.</p>
              ...
              <div className="relative bg-white border border-[#D8D5CF] rounded-2xl p-8 overflow-hidden shadow-sm">
                ...
                <div className="flex items-start gap-4 mb-5">
                  <div className="w-10 h-10 rounded-xl bg-[#3E8F5E]/10 border border-[#3E8F5E]/20 flex items-center justify-center flex-shrink-0">
                    <Globe2 className="w-5 h-5 text-[#3E8F5E]" strokeWidth={1.5} />
                  </div>
                  <h3 className="font-heading font-bold text-lg text-[#16291E] pt-2">Third-Party Websites</h3>
                </div>
                <div className="h-px bg-[#D8D5CF] mb-5" />
                <div className="space-y-5">
              ...
              {cookieTypes.map((cookie) => {
                ...
                return (
                  <div key={cookie.title} className="group relative bg-white border border-[#D8D5CF] rounded-xl p-6 hover:shadow-md transition-all duration-300 overflow-hidden shadow-sm">
                    ...
                    <h3 className="font-heading font-bold text-base text-[#16291E] mb-2">{cookie.title}</h3>
            ...
            <div className="grid lg:grid-cols-2 gap-5">
              {additionalCookieDetails.map((item) => (
                <div key={item.title} className="group relative bg-white border border-[#D8D5CF] rounded-xl p-6 hover:shadow-md transition-all duration-300 overflow-hidden shadow-sm">
                  ...
                  <h3 className="font-heading font-bold text-base text-[#16291E] mb-3">{item.title}</h3>
                  <div className="h-px bg-[#D8D5CF] mb-3" />
                  <p className="text-base text-[#7A7E8F] leading-relaxed">{item.desc}</p>
                </div>
              ))}
            </div>
            <div className="mt-8 relative bg-gradient-to-br from-[#2F7549]/10 to-[#2F7549]/10 border border-[#2F7549]/20 rounded-xl p-6 overflow-hidden">
              <div className="relative">
                <Cookie className="w-5 h-5 text-[#2F7549] mb-3" strokeWidth={1.5} />
          ...
          <AnimatedSection>
            ...
            <div className="grid lg:grid-cols-3 gap-5 max-w-5xl">
              <div className="relative bg-white border border-[#D8D5CF] rounded-2xl p-8 overflow-hidden shadow-sm">
                ...
                <div className="flex items-start gap-4 mb-5">
                  <div className="w-10 h-10 rounded-xl bg-[#2F7549]/10 border border-[#2F7549]/20 flex items-center justify-center flex-shrink-0">
                    <RefreshCw className="w-5 h-5 text-[#2F7549]" strokeWidth={1.5} />
                  </div>
                </div>
              ...
              <div className="relative bg-white border border-[#D8D5CF] rounded-2xl p-8 overflow-hidden shadow-sm">
                ...
                <div className="flex items-start gap-4 mb-5">
                  <div className="w-10 h-10 rounded-xl bg-[#3E8F5E]/10 border border-[#3E8F5E]/20 flex items-center justify-center flex-shrink-0">
                    <CheckCircle2 className="w-5 h-5 text-[#3E8F5E]" strokeWidth={1.5} />
                  </div>
                </div>
                <h3 className="font-heading font-bold text-base text-[#16291E] mb-3">Review</h3>
                <div className="h-px bg-[#D8D5CF] mb-3" />
              ...
              <div className="relative bg-white border border-[#D8D5CF] rounded-2xl p-8 overflow-hidden shadow-sm">
                ...
                <h3 className="font-heading font-bold text-base text-[#16291E] mb-3">General</h3>
                <div className="h-px bg-[#D8D5CF] mb-3" />
