...
const termsSections = [
  ...
  },
  {
    ...
    content: [
      "4.1 You may obtain direct access via the Website to certain confidential information of UK-Pakistan Trade and Investment Board Ltd (UPTIB) and its suppliers, including without limitation technical, contractual, product, programme, pricing, marketing and other valuable information that should reasonably be understood as confidential (“Confidential Information”). You must hold Confidential Information in strict confidence. Title to Confidential Information remains with UK-Pakistan Trade and Investment Board Ltd (UPTIB) and its suppliers.",
  ...
  },
  {
    ...
    content: [
      ...
      "6.11 Except as expressly authorised by UK-Pakistan Trade and Investment Board Ltd (UPTIB) or by Content providers, You agree not to reproduce, modify, rent, lease, loan, sell, distribute, mirror, frame, republish, download, transmit, or create derivative works of the Content of others, in whole or in part, by any means. You must not modify, decompile, or reverse engineer any software UK-Pakistan Trade and Investment Board Ltd (UPTIB) discloses to You, and You must not remove or modify any copyright or trademark notice, or other notice of ownership.",
