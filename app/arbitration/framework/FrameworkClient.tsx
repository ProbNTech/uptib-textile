...
const platformFeatures = [
  { title: "Secure Access", description: "Two-factor authentication (2FA) with role-based access for Claimant, Respondent, Arbitrator, and Administrator.", icon: KeyRound, color: "#047857" },
  { title: "Case Dashboard", description: "Notifications, case summary with status and timeline, document repository, and encrypted messaging system.", icon: Monitor, color: "#10B981" },
  { title: "Digital Filing", description: "Submit notices, claims, defences, and evidence in PDF or approved digital formats with automatic timestamping.", icon: Upload, color: "#047857" },
  { title: "Virtual Hearings", description: "Integrated video conferencing for virtual and hybrid hearing sessions with secure platform-provided links.", icon: Video, color: "#047857" },
  { title: "Automated Reminders", description: "Real-time alerts for deadlines, hearings, new messages, and procedural updates to keep proceedings on track.", icon: Bell, color: "#10B981" },
  { title: "Security & Compliance", description: "All communications encrypted. GDPR and UK data protection compliant. Access restricted to authorised users. Training sessions offered for first-time users.", icon: Fingerprint, color: "#047857" },
];
  ...
  return (
          ...
          >
            <div className="rounded-2xl border border-[#D8D5CF] bg-white shadow-sm p-8 sticky top-8">
              ...
              <div className="mt-5 pt-4 border-t border-[#D8D5CF]">
                <p className="text-xs text-[#5A5F72]"><span className="font-semibold text-[#047857]">Excluded:</span> Employment disputes (separate HR policy) and regulatory/statutory enforcement matters.</p>
              </div>
            </div>
          </motion.div>
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-8">
            ...
            <div className="p-7">
              <div className="flex items-center gap-3 mb-5">
                <div className="w-10 h-10 rounded-xl flex items-center justify-center" style={{ background: "#10B98110", border: "1px solid #10B98120" }}>
                  <FileText className="w-5 h-5 text-[#10B981]" strokeWidth={1.5} />
                </div>
              ...
              <ul className="space-y-2.5">
                {[
                  ...
                  <li key={item} className="flex items-start gap-2.5">
                    <CheckCircle2 className="w-3.5 h-3.5 text-[#10B981] mt-0.5 flex-shrink-0" strokeWidth={2} />
                    <span className="text-[#5A5F72] text-sm leading-relaxed">{item}</span>
                  </li>
                ))}
              </ul>
          ...
          <motion.div initial={shouldReduceMotion ? { opacity: 1 } : { opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.4, delay: 0.1 }} className="rounded-2xl border border-[#D8D5CF] bg-white shadow-sm overflow-hidden">
            ...
            <div className="p-7">
              <div className="flex items-center gap-3 mb-5">
                <div className="w-10 h-10 rounded-xl flex items-center justify-center" style={{ background: "#04785710", border: "1px solid #04785720" }}>
                  <ClipboardList className="w-5 h-5 text-[#047857]" strokeWidth={1.5} />
                </div>
      ...
      <AnimatedSection>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-5">
          {keyPrinciples.map((p, i) => {
            const Icon = p.icon;
            const lightColors = ["#6EE7B7", "#86efac", "#F9A8B4", "#6EE7B7", "#86efac"];
            ...
            <div className="space-y-3">
              {appointmentTimeline.map((item, i) => (
                <motion.div key={item.step} initial={shouldReduceMotion ? { opacity: 1 } : { opacity: 0, x: -10 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.3, delay: i * 0.08 }} className="flex items-center justify-between bg-white/5 backdrop-blur-sm rounded-lg border border-white/10 px-4 py-3">
                  ...
                  <span className="text-xs font-bold text-[#10B981] bg-[#10B981]/8 px-2.5 py-1 rounded-full">{item.duration}</span>
                </motion.div>
              ))}
            </div>
          </div>
    ...
    < Section variant = "light" >
      <AnimatedSection>
        ...
        <AnimatedSection delay={0.2}>
          <div className="mt-6 rounded-xl bg-gradient-to-r from-[#047857]/8 to-transparent border border-[#047857]/15 p-6">
        ...
        <AnimatedSection delay={0.3}>
          <motion.div initial={shouldReduceMotion ? { opacity: 1 } : { opacity: 0, y: 12 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.4 }} className="mt-8 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm overflow-hidden">
            ...
            <div className="p-7 lg:p-8 flex items-start gap-5">
              <div className="w-12 h-12 rounded-xl flex items-center justify-center flex-shrink-0" style={{ background: "#04785710", border: "1px solid #04785720" }}>
                <Blocks className="w-6 h-6 text-[#047857]" strokeWidth={1.5} />
              </div>
              <div>
    ...
    < Section variant = "light" >
      <AnimatedSection>
        ...
        <motion.div initial={shouldReduceMotion ? { opacity: 1 } : { opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.4 }} className="rounded-2xl border border-[#10B981]/15 bg-white shadow-sm overflow-hidden">
          <div className="h-1 w-full bg-gradient-to-r from-[#10B981] via-[#047857] to-[#10B981]" />
          <div className="p-8 lg:p-10">
            <blockquote className="relative border-l-4 border-[#10B981] pl-6 py-5 bg-gradient-to-r from-[#10B981]/5 to-transparent rounded-r-xl">
              <div className="absolute -left-1 -top-2 text-[#10B981]/20 text-6xl font-serif leading-none">&ldquo;</div>
          ...
          {faqs.map((faq, i) => (
            <motion.div key={i} initial={shouldReduceMotion ? { opacity: 1 } : { opacity: 0, y: 12 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.3, delay: i * 0.05 }} className="rounded-xl border border-white/10 bg-white/5 backdrop-blur-sm p-6 hover:shadow-md transition-shadow duration-300">
              <div className="flex items-start gap-3">
                <div className="w-7 h-7 rounded-lg bg-[#047857]/10 flex items-center justify-center flex-shrink-0 mt-0.5">
                  <HelpCircle className="w-4 h-4 text-[#047857]" strokeWidth={2} />
                </div>
                <div>
