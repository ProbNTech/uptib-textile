...
const yourRights = [
  ...
  { icon: UserCheck, title: "Right to Correction", color: "#10B981", desc: "We shall update, archive or securely delete information if it goes out of date. You have the right to have inaccurate or incomplete information we hold about you corrected." },
  { icon: Lock, title: "Right to Restrict Use", color: "#047857", desc: "You have a right to ask us to restrict the processing of some or all your personal information if there is a disagreement about its accuracy or we\u2019re not lawfully allowed to use it." },
  { icon: Ban, title: "Right of Erasure", color: "#047857", desc: "You may ask us to delete some or all your personal information and in certain cases, and subject to certain exceptions; we will do so as far as we are required to. In many cases, we will anonymize that information, rather than delete it." },
  { icon: ArrowRightLeft, title: "Right to Portability", color: "#10B981", desc: "If we are processing your personal information (1) based on your consent, or in order to enter into or carry out a contract with you, and (2) the processing is being done by automated means, you may ask us to provide it to you or another service provider in a machine-readable format." },
...
const lawfulBases = [
  { icon: FileText, title: "Performance of a Contract", color: "#047857", desc: "Where we are entering into a contract with you or performing our obligations under it, for example when you became a \u2018paying\u2019 member of our network." },
  { icon: Scale, title: "Legal Obligation", color: "#10B981", desc: "Where necessary, we can comply with a legal or regulatory obligation to which we are subject." },
  { icon: CheckCircle2, title: "Legitimate Interests", color: "#047857", desc: "Where it is reasonably necessary to achieve our legitimate interests, i.e. those required for running UPTIB as a B2B strategic networking organization in pursuit of our shared aims and ideals." },
  { icon: Mail, title: "Specific Consent", color: "#047857", desc: "Where you have provided specific consent to us using your personal information in a certain way, such as to send you email, text and/or contact via telephone." },
];
      ...
      <section className="relative py-10 overflow-hidden bg-white">
        ...
        <div className="relative px-8 sm:px-12 lg:px-16 xl:px-20">
          <AnimatedSection>
            ...
            <motion.div initial={shouldReduceMotion ? { opacity: 1 } : { opacity: 0, y: 12 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-30px" }} transition={{ duration: 0.4, delay: 0.3 }} className="mt-8 relative bg-gradient-to-br from-[#10B981]/10 to-[#047857]/10 border border-[#10B981]/20 rounded-xl p-6 overflow-hidden">
              <div className="relative">
                <Mail className="w-5 h-5 text-[#10B981] mb-3" strokeWidth={1.5} />
                <p className="text-[#5A5F72] text-base leading-relaxed">If you want to exercise any of the above rights, please email us at{" "}<a href="mailto:info@ukpaktrade.org.uk" className="text-[#10B981] hover:text-[#4ade80] transition-colors">info@ukpaktrade.org.uk</a>{" "}and clearly state in the email subject line: RIGHTS REQUEST. We may be required to ask for further information and/or evidence of identity. We will endeavor to respond fully to all requests within 10 working days of your request, however if we are unable to do so we will contact you with reasons for the delay.</p>
          ...
          <AnimatedSection>
            ...
            <div>
              <motion.div initial={shouldReduceMotion ? { opacity: 1 } : { opacity: 0, y: 12 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-30px" }} transition={{ duration: 0.4 }} className="grid grid-cols-[1fr_2fr] gap-4 px-6 py-4 mb-2">
                <div className="text-base font-bold tracking-[0.2em] uppercase text-[#047857]">Category</div>
                <div className="text-base font-bold tracking-[0.2em] uppercase text-[#047857]">Retention Period</div>
              </motion.div>
                ...
                <motion.div key={item.category} initial={shouldReduceMotion ? { opacity: 1 } : { opacity: 0, y: 12 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, margin: "-30px" }} transition={{ duration: 0.4, delay: i * 0.05 }} className="group grid grid-cols-[1fr_2fr] gap-4 relative bg-white border border-[#D8D5CF] rounded-xl px-6 py-5 mb-3 hover:shadow-md transition-all duration-300 overflow-hidden shadow-sm">
                  ...
                  <div className="flex items-center gap-3">
                    <div className="w-8 h-8 rounded-lg bg-[#047857]/10 border border-[#047857]/20 flex items-center justify-center flex-shrink-0">
                      <Clock className="w-4 h-4 text-[#047857]" strokeWidth={1.5} />
                    </div>
