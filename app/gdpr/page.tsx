...
const yourRights = [
  { title: "Right of Access", desc: "You have a right to request access to the personal data that we hold about you. You also have the right to request a copy of the information we hold about you, and we will provide you with this unless legal exceptions apply. If you want to access your information, please send a description of the information you want to see and proof of your identity by email: info@paktextileglobal.com" },
      ...
      <PolicyDoc toc={toc}>
        <PolicySection id="data-subject-rights" eyebrow="GDPR Compliance" title="Data Subject Rights">
          <p>
            ...
            of personal data on{" "}
            <a href="https://paktextileglobal.com" target="_blank" rel="noopener noreferrer" className="font-medium text-[#394F73] underline underline-offset-2">paktextileglobal.com</a>.
          </p>
        ...
        <PolicySection id="your-rights" eyebrow="Your Rights" title="Rights Under UK Data Protection Law">
          ...
          <p className="pt-2">
            ...
            <a href="mailto:info@paktextileglobal.com" className="whitespace-nowrap font-medium text-[#394F73] underline underline-offset-2">info@paktextileglobal.com</a>{" "}
